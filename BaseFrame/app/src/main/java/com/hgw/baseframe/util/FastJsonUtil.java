...
public class FastJsonUtil {
    ...
    /**
     * 把对象转化为json字符串
     * @param obj 要转化的对象	 * @return 返回json字符串
     */
    ...
    /**
     * 把json字符串转化为对象
     * @param jsonString 要转化的对象
     * @return 返回beanClazz
     */
    public static <T> T parseToJavaBean(String jsonString ,Class<T> beanClazz){
        try{
            if(jsonString == null){
                return null;
            }
