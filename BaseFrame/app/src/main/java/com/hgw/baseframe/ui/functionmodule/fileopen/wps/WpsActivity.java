package com.hgw.baseframe.ui.functionmodule.fileopen.wps;
...
import com.hgw.baseframe.ui.basemodule.http.okhttp.OkhttpActivity;
import com.hgw.baseframe.ui.basemodule.http.retrofit.RetrofitActivity;
...
public class WpsActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void toActivity(Context context) {
        Intent intent = new Intent(context, WpsActivity.class);
