...
/**
 * 描述：自定义XRecyclerView
 * （重写XRecyclerView源码，通过自定义ArrowRefreshHeader、LoadingMoreFooter来修改header和footer）
 * @author hgw
 */
public class CustomXRecyclerView extends RecyclerView {
    ...
    private CustomArrowRefreshHeader mRefreshHeader;
    ...
    private void init() {
        if (pullRefreshEnabled) {
            mRefreshHeader = new CustomArrowRefreshHeader(getContext());
            //mRefreshHeader.setProgressStyle(mRefreshProgressStyle);
        }
        CustomLoadingMoreFooter footView = new CustomLoadingMoreFooter(getContext());
        mFootView = footView;
    ...
    public void loadMoreComplete() {
        isLoadingData = false;
        if (mFootView instanceof CustomLoadingMoreFooter) {
            ((CustomLoadingMoreFooter) mFootView).setState(CustomLoadingMoreFooter.STATE_COMPLETE);
        } else {
    ...
    public void setNoMore(boolean noMore){
        ...
        isNoMore = noMore;
        if (mFootView instanceof CustomLoadingMoreFooter) {
            ((CustomLoadingMoreFooter) mFootView).setState(isNoMore ? CustomLoadingMoreFooter.STATE_NOMORE:CustomLoadingMoreFooter.STATE_COMPLETE);
        } else {
            mFootView.setVisibility(View.GONE);
        }
    }
    ...
    public void setRefreshHeader(CustomArrowRefreshHeader refreshHeader) {
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0
                ...
                isLoadingData = true;
                if (mFootView instanceof CustomLoadingMoreFooter) {
                    ((CustomLoadingMoreFooter) mFootView).setState(CustomLoadingMoreFooter.STATE_LOADING);
                } else {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    CustomXRecyclerView.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    CustomXRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
